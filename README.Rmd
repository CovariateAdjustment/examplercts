...
Datasets are from various different aspects of medical research, and contain continuous, binary, ordinal, and time-to-event outcomes. Some outcomes are assessed at a single point in time, while others are assessed longitudinally. An overview of the outcome types in each dataset is provided below.
